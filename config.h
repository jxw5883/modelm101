...
//#define MATRIX_COL_PINS { F0, F1, F4, F5, F6, F7, B6, B5, B4, D7, D4, D3, C6, C7, D5, E6}
// arduino micro wiring
#define MATRIX_ROW_PINS { F7, F6, F5, F4, F1, F0, B3, B1 }
#define MATRIX_COL_PINS { C7, D2, D3, B0, B2, D6, B7, B6, B5, B4, E6, D7, C6, D4, D0, D1 }
...
//#define IS_COMMAND() (get_mods() == (MOD_BIT(KC_LCONTROL) | MOD_BIT(KC_RCONTROL)))
...
//const uint16_t PROGMEM pause_p[] = {KC_PAUSE, KC_P, COMBO_END};
